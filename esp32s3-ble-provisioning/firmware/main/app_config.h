...
#ifndef APP_ALLOW_WEAK_POP_FOR_DEVELOPMENT
#warning "APP_PROV_POP is a development placeholder. Set unique PoP per device in manufacturing."
#endif
#define APP_CUSTOM_ENDPOINT_NAME "custom-data"
#define APP_BUTTON_RESET_GPIO 0
#define APP_BUTTON_LONG_PRESS_MS 3000

/* TODO(Security2): add username + SRP config fields here */
/* TODO(SoftAP): add fallback SoftAP provisioning config */
